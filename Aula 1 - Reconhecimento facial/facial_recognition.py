...
#leia as imagens e reconheça as pessoas
def load_images_from_folder(folder):
    #pegar as imagens e transformar em vetor para que consiga reconhecer no algoritimo
...
def main():
    ...
    while True:
        ...
        face_names = []  # Lista para armazenar os nomes das faces detectadas, pode ter mais de uma pessoa por isso array
        for face_encoding in face_encodings:
            ...
            best_match_index = np.argmin(face_distances)  # Encontrar o índice da melhor correspondência, argumento minimo entre as distancias
